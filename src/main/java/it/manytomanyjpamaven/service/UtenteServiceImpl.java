...
import it.prova.manytomanyjpamaven.exception.UtenteConRuoliAssociatiException;
...
public class UtenteServiceImpl implements UtenteService {
	...
	public void rimuovi(Long idUtente) throws Exception {
		...
		try {
			...
			Utente utenteDaRimuovere = utenteDAO.findByIdFetchingRuoli(idUtente);
			if (!utenteDaRimuovere.getRuoli().isEmpty()) {
				throw new UtenteConRuoliAssociatiException("Impossibile rimuovere utente: ha dei ruoli assegnati");
			}

			utenteDAO.delete(utenteDaRimuovere);
	...
	// METODO PER DISASSOCIARE UN RUOLO DA UN UTENTE
	@Override
	...
	public List<Utente> cercaUtentiConPasswordMinoreDiOttoCaratteri() throws Exception {
		...
		try {
			...
			return utenteDAO.findUsersWhosePasswordHasLessThanEightCharacters();
